...
class TestFileAccess(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.client = nextcloud.Client(Config['nextcloud_url'], single_session = Config['single_session'])
        self.client.login(Config['nextcloud_login'], Config['nextcloud_password'])
        ...
        self.share2user = Config['nextcloud_share2user']
    ...
    def test_get_share_user(self, file_name):
        ...
        self.assertEquals(sinfo.get_uid_owner(), Config['nextcloud_login'])
...
class TestUserAndGroupActions(unittest.TestCase):
    ...
    def test_user_exists(self):
        self.assertTrue(self.client.user_exists(Config['nextcloud_login']))
        try:
    ...
    def test_get_user(self):
        output = self.client.get_user(Config['nextcloud_login'])
    ...
    def test_search_users(self):
        user_name = Config['nextcloud_login']
...
class TestApps(unittest.TestCase):
    ...
    def setUp(self):
        self.client = nextcloud.Client(Config['nextcloud_url'])
        self.client.login(Config['nextcloud_login'], Config['nextcloud_password'])
